export default {
    ...
    Zhang: {
        ...
        description: "Easy and affordable chinese restaurant to grab some food. Conveniently located in the main station. ",
    ...
    BistroMain: {
        ...
        description: "Every slice of pizza at Bistro Stazione is prepared quickly and freshly for you when you visit us at the main train station in Innsbruck.",
    ...
    TestaRossa: {
        name: "Testa Rossa",
        description: "We offer you true coffee enjoyment in the middle of the main train station in Innsbruck. Enjoy a cup of creamy cappuccino in our coffee bar or take your original Italian coffee to go with you on your journey.",
    ...
    Ruetz: {
        ...
        description: "Quality and the best taste are the maxims of the Ruetz bakery. Ruetz breads are made exclusively with the best quality raw materials and ingredients and home-grown pre-doughs.",
    ...
    DiePizzerei: {
        name: "Die Pizzerei",
        description: "In the heart of Innsbruck we serve the best Italian dishes and pizzas from the wood-fired oven. Our ingredients and wines were hand-picked in Italy and South Tyrol.",
        website: "https://www.diepizzerei.at/",
        operatinghours: "Monday - Saturday: 11:30-14:00 & 17:30-24:00 Sunday 17:30-23:00",
        reservation: "Yes",
        type: "Casual Italian Dinning",
        location: "Innsbruck City Center",
        map: ""
    },
    Bierstindl: {
        name: "Bierstindl",
        description: "A good Bavarian Obatzda, a juicy pork belly or just a light salad for in-between meals. Our kitchen team will spoil you with Tyrolean specialties, Bavarian delicacies and provide variety with seasonal dishes.",
    ...
    Taverna: {
        ...
        description: "Fantastic restaurent in beautiful small town. Feels like eating in Italy, really authentic Italian food. Service is great, friendly and caring staff.",
        website: "",
    ...
    BunDito: {
        ...
        description: "At Bun-Dito, quality, taste and attention to detail are our top priority. We are passionate about preparing high-quality dishes from fresh, regional products - always with care and heart.",
    ...
    CafeBar: {
        ...
        description: "Coffee house charm with a breeze of jungle in the heart of the alps. From the newest mountain gossip to the successful day of freelance home office rewarding yourself with handcrafted food, powerful Kraftbeer and fistful of booze.",
    ...
    Fuchs: {
        ...
        description: "Low key bar tucked away in a quiet spot of Innsbruck. Enjoy classy cocktails and signature sandwiches in a elegant ambiance.",
    ...
    Sudtiroler: {
        ...
        description: "Let yourself be pampered in a relaxed atmosphere with carefully prepared, fresh dishes and selected wines.",
